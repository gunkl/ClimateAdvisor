...
| What are the skill registry, execution pipeline, and per-skill contracts? | `AISkillRegistry` 6-step pipeline; `activity_report` 11–12 section context (12th section HISTORICAL DAILY SUMMARIES added when `hours > 36`); `investigator` 7-source context with GitHub issues. Both have deterministic fallbacks. | [AI Skills Framework Spec](ai-skills-spec.md) |
