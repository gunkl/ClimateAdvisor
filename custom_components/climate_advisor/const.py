...
API_PENDING_TESTS = f"{API_BASE}/pending_tests"
API_APPROVE_PENDING_TEST = f"{API_BASE}/approve_pending_test"
API_RUN_SIMULATION_LOOP = f"{API_BASE}/run_simulation_loop"
