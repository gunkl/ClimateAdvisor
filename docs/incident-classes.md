...
|---|---|---|---|---|---|
| `comfort_violation` | Indoor > comfort_cool or < comfort_heat for more than 15 min | Reactive | Both | Low (visible to user) | Baseline coverage |
| `comfort_undertemp` | Indoor < comfort_heat for more than 15 min (sub-class of comfort_violation, tracked separately) | Reactive | Both | Low (visible) | Baseline coverage |
